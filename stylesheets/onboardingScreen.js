...
export const getStyles = (width,height) => {
  ...
  const deviceGroupStyles = {
    ...
    group2: {
        container: "pt-16 px-8 flex-1 items-center",
        step0MainHeader : "text-2xl pt-2 text-center mb-3 mt-2 font-normal text-black",
        step1MainHeader : "text-2xl text-center mb-3 mt-8 font-normal text-black",
        step2MainHeader: "text-2xl px-8 text-center mb-3 mt-8 font-normal text-black",
        step3MainHeader: "text-2xl text-center mb-3 mt-8 font-normal text-black",
        step4MainHeader: "text-2xl px-8 text-center mb-3 mt-8 font-normal text-black",
    ...
    group3: {
        ...
        step2MainHeader: "text-2xl px-8 text-center mb-3 mt-2 font-normal text-black",
        step3MainHeader: "text-2xl text-center mb-3 mt-2 font-normal text-black",
        step4MainHeader: "text-2xl px-8 text-center mb-3 mt-2 font-normal text-black",
        subHeader: "text-sm text-center mb-5 mt-2 text-gray-600 leading-5 px-2",
        buttonText: "text-base font-medium",
        selectButton: "rounded-[10px] py-4 px-4 items-center justify-center mb-6 bg-black active:bg-neutral-800 active:scale-[0.98]",
        ...
        step1ButtonsGroup: "flex-2 px-8 pb-60 pt-6",
        step3ButtonsGroup: "flex-2 px-8 pb-40 pt-10",
    ...
    group4: {
      ...
      step0MainHeader: "text-[28px] text-center mb-3 mt-6 font-normal text-black",
      ...
      step3ButtonsGroup: "flex-2 px-8 pb-48 pt-6",
      step4ButtonsGroup: "flex-2 px-8 pb-60 pt-6",
    ...
    group5: {
        ...
        step0MainHeader: "text-[30px] text-center mb-3  font-normal text-black",
        step1MainHeader: "text-[30px] text-center mb-3  mt-3  font-normal text-black",
        step2MainHeader: "text-[30px] text-center mb-3 mt-3 font-normal text-black",
        step3MainHeader: "text-[29px] text-center  mb-3 mt-3 font-normal text-black",
        step4MainHeader: "text-[30px] text-center mb-3 mt-3 font-normal text-black",
        ...
        step0ButtonsGroup: "flex-2 px-8 pb-40",
        step1ButtonsGroup: "flex-2 px-8 pb-56 ",
        step3ButtonsGroup: "flex-2 px-8 pb-44 pt-10",
        step4ButtonsGroup: "flex-2 px-8 pb-56 ",
        sliderContinueButton: "bg-black rounded-[10px] py-4 px-3 items-center w-full mb-44",
        continueButtonText:"text-white text-base font-medium",
        continueButton: "bg-black rounded-[10px] py-4 px-3 items-center w-full mt-5 mb-60",
    ...
    group6: {
        ...
        step1ButtonsGroup: "flex-2 px-8 pb-64 ",
        step3ButtonsGroup: "flex-2 px-8 pb-48",
        step4ButtonsGroup: "flex-2 px-8 pb-60 ",
    ...
    group7: {
        container: "pt-28 px-10 flex-1 items-center",
        step0MainHeader: "text-[32px] text-center mb-3 mt-3 font-normal text-black",
        ...
        step0ButtonsGroup: "flex-2 px-8 pb-40",
        step1ButtonsGroup: "flex-2 px-8 pb-56 ",
        step3ButtonsGroup: "flex-2 px-8 pb-40",
        step4ButtonsGroup: "flex-2 px-8 pb-52 ",
        sliderContinueButton: "bg-black rounded-[10px] py-4 px-3 items-center w-full mb-44",
        continueButtonText:"text-white text-base font-medium",
        continueButton: "bg-black rounded-[10px] py-4 px-3 items-center w-full mt-5 mb-60",
        reviewImage:" w-80 h-64 border rounded-xl mt-4  border-[#D9D9D9] p-3 object-contain self-center   ",
    ...
    group8: {
        ...
        step2MainHeader: "text-[32px] text-center mb-3 mt-8 px-12 font-normal text-black",
        step3MainHeader: "text-[32px] text-center  mb-3 mt-8 font-normal text-black",
        step4MainHeader: "text-[32px] text-center mb-3 mt-8 px-6 font-normal text-black",
        subHeader: "text-base text-center mb-5 mt-3 text-gray-600 leading-[22px] px-3",
        buttonText: "text-lg font-medium ",
        ...
        step1ButtonsGroup: "flex-2 px-8 pb-64 ",
        step3ButtonsGroup: "flex-2 px-8 pb-48",
        step4ButtonsGroup: "flex-2 px-8 pb-64 ",
        sliderContinueButton: "bg-black rounded-[10px] py-4 px-3 items-center w-full mb-52",
        continueButtonText:"text-white text-base font-medium",
        continueButton: "bg-black rounded-[10px] py-4 px-3 items-center w-full mt-5 mb-60",
        reviewImage:" w-80 h-64 border rounded-xl mt-4  border-[#D9D9D9] p-3 object-contain self-center   ",
    ...
    group9 : {
        ...
        step0MainHeader: "text-[32px] text-center mb-3 mt-8 font-normal text-black",
        step1MainHeader: "text-[32px] text-center mb-3 mt-8   font-normal text-black",
        step2MainHeader: "text-[32px] text-center mb-3 mt-8 px-2 font-normal text-black",
        step3MainHeader: "text-[32px] text-center  mb-3 mt-8 font-normal text-black",
        step4MainHeader: "text-[32px] text-center mb-3 mt-8 px-6 font-normal text-black",
        subHeader: "text-base text-center mb-5 mt-3 text-gray-600 leading-[22px] px-3",
        buttonText: "text-lg font-medium ",
    ...
    group10 : {
        ...
        step2MainHeader: "text-[34px] text-center mb-3 mt-8 px-2 font-normal text-black",
        step3MainHeader: "text-[34px] text-center  mb-3 mt-8 font-normal text-black",
        step4MainHeader: "text-[34px] text-center mb-3 mt-8 px-2 font-normal text-black",
        subHeader: "text-base text-center mb-5 mt-3 text-gray-600 leading-[22px] px-3",
        buttonText: "text-lg font-medium ",
        ...
        step1ButtonsGroup: "flex-2 px-8 pb-64 ",
        step3ButtonsGroup: "flex-2 px-8 pb-40",
        step4ButtonsGroup: "flex-2 px-8 pb-64 mb-6 ",
    ...
    unknown : {
        container: "pt-32 px-16 flex-1 items-center",
