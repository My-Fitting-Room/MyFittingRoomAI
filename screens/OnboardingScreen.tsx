// import { View, TouchableOpacity, Text, Alert, Image, Pressable, ActivityIndicator, Dimensions, TextInput, Share } from "react-native";import React, { useEffect, useState } from "react";
...
//       const { error: updateError } = await supabase
//         .from("profiles")
//         .update({ onboarding_wizard_step: 1 })
//         .eq("id", profile.id);
...
//                 style={{ fontFamily: FONTS.SATOSHI }}
//               >
//                 Enter a friends referral code and get a free try-on!
//               </Text>
//             </View>
//           </View>
...
//               onPress={() => handleSelection("referral_source", "instagram", 2, setReferralSource)}
//             >
...
//             <Pressable 
//               className={styles.socialButton}
//               onPress={() => handleSelection("referral_source", "facebook", 2, setReferralSource)}
//             >
...
//             <Pressable 
//               className={styles.socialButton}
//               onPress={() => handleSelection("referral_source", "tiktok", 2, setReferralSource)}
//             >
...
//             <Pressable 
//               className={styles.socialButton}
//               onPress={() => handleSelection("referral_source", "youtube", 2, setReferralSource)}
//             >
...
//             <Pressable 
//               className={styles.socialButton}
//               onPress={() => handleSelection("referral_source", "friends_or_family", 2, setReferralSource)}
//             >
...
//             <Pressable 
//               className={styles.selectButton}
//               onPress={() => handleSelection("size_picking_confidence", "very", 3, setSizePickingConfidence)}
//             >
//               <Text 
...
//             <Pressable 
//               className={styles.selectButton}
//               onPress={() => handleSelection("size_picking_confidence", "somewhat", 3, setSizePickingConfidence)}
//             >
//               <Text 
...
//             <Pressable 
//               className={styles.selectButton}
//               onPress={() => handleSelection("size_picking_confidence", "not", 3, setSizePickingConfidence)}
//             >
//               <Text 
...
//               onPress={() => handleSelection("clothing_purchase_regrets", sliderValue, 4, setClothingPurchaseRegrets)}
//             >
//               <Text 
//                 className={styles.continueButtonText}
//                 style={{ fontFamily: FONTS.SATOSHI }}
...
//             <Pressable 
//               className={styles.selectButton}
//               onPress={() => handleSelection(null, null, 5)}
//             >
//               <Text 
//                 className={styles.continueButtonText}
//                 style={{ fontFamily: FONTS.SATOSHI }}
...
//             <Pressable 
//               className={styles.selectButton}
//               onPress={() => handleSelection("return_hesitation", "yes", 6, setReturnHesitation)}
//             >
//               <Text 
...
//             <Pressable 
//               className={styles.selectButton}
//               onPress={() => handleSelection("return_hesitation", "no", 6, setReturnHesitation)}
//             >
//               <Text 
