...
//   const maxPages = Math.ceil(clothesImages.length / imagesPerPage);
...
//     const endIndex = Math.min(startIndex + imagesPerPage, clothesImages.length);
//     const visibleImages = clothesImages.slice(startIndex, endIndex);
...
//                 selectedClothesImage?.id === image.id && styles.selectedCarouselImage
//               ]}
...
import { View, Text, StyleSheet, TouchableOpacity, ActivityIndicator, Image, Dimensions, Alert, ScrollView } from "react-native";
import Ionicons from "react-native-vector-icons/Ionicons";
import Feathericons from "react-native-vector-icons/Feather";
import React, { useEffect, useState } from "react";
import { supabase } from "../App";
